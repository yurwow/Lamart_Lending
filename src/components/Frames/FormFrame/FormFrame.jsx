...
const FormFrame = forwardRef((props, ref) => {
    ...
    const lampImages = [lamp, lamp2, lamp, lamp2, lamp3];
        ...
        <div>
                    ...
                    <div className={styles.section_form_container}>
                        ...
                        {textBlocks?.length > 0 ? (
                            ...
                            <span className={styles.form_title}>
                                НАСТРОИМ ОНЛАЙН-ПЛАТФОРМУ ОТКРЫТЫЕ ИДЕИ ПОД ВАШИ ЗАДАЧИ
                            </span>
                        )}
                        {textBlocks?.length > 0 ? (
                            <span
                                style={{
                                    ...
                                    fontFamily:
                                        `${textBlocks[1]?.styles?.fontFamily}, sans-serif` ||
                                        'Montserrat Alternates, sans-serif',
                            ...
                            <p className={styles.form_p}>
                                Ответим на вопросы, внедрим платформу, импортируем данные, научим решать любые задачи в
                                <br /> одном окне браузера и получать аналитику с помощью отчетов
                            </p>
                        )}
            ...
            <section className={styles.section_sun}>
                <div className={styles.sun_container}>
                    ...
                    <img
                        onClick={handleClick}
                        className={`${styles.icon_down} ${isMoved ? styles.active : ''}`}
                        src={iconDown}
                        alt="icon down"
                    />
                </div>
                <div className={styles.sun_text_container}>
                    <span className={styles.sun_text}>
                        НОВЫЕ <span style={{ color: '#1E4DC2', marginLeft: '6px' }}>ИДЕИ</span>
                    </span>
