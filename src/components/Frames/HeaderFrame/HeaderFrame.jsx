                                ...
                                style={{
                                    ...
                                    fontSize: isMobileDevice
                                        ...
                                        : textBlocks[0]?.styles?.fontSize
                                          ...
                                          : '14px',
                                    fontFamily:
                                        `${textBlocks[0]?.styles?.fontFamily}, sans-serif` || 'Poppins, sans-serif',
                            ...
                            style={{
                                ...
                                fontSize: isMobileDevice
                                    ? textBlocks[2]?.styles?.mobileFontSize
                                        ? `${textBlocks[2]?.styles?.mobileFontSize}px`
                                        : '14px'
                    ...
                    {textBlocks?.length > 0 ? (
                        <span
                            style={{
                                ...
                                fontSize: isMobileDevice
                                    ? textBlocks[3]?.styles?.mobileFontSize
                                        ? `${textBlocks[3]?.styles?.mobileFontSize}px`
                                        : '14px'
                                    : textBlocks[3]?.styles?.fontSize
                                      ? `${textBlocks[3]?.styles?.fontSize}px`
                                      : '14px',
                                fontFamily:
                                    `${textBlocks[3]?.styles?.fontFamily}, sans-serif` ||
                                    'Montserrat Alternates, sans-serif',
                    ...
                    {textBlocks?.length > 0 ? (
                        <span
                            style={{
                                ...
                                fontSize: isMobileDevice
                                    ? textBlocks[4]?.styles?.mobileFontSize
                                        ? `${textBlocks[4]?.styles?.mobileFontSize}px`
                                        : '14px'
                                    : textBlocks[4]?.styles?.fontSize
                                      ? `${textBlocks[4]?.styles?.fontSize}px`
                                      : '14px',
                                fontFamily:
                                    `${textBlocks[4]?.styles?.fontFamily}, sans-serif` ||
                                    'Montserrat Alternates, sans-serif',
                        ...
                        <span className={styles.section_one_span}>
                            Информационная система, разработанная для сбора, оценки и управления предложениями
                            сотрудников по оптимизации различных процессов в компании
                        </span>
                    )}
