...
const ClientsFrame = ({ textBlocks = [] }: FrameProps) => {
                    ...
                    style={{
                        ...
                        fontSize: isMobileDevice
                            ...
                            : textBlocks[1]?.styles?.fontSize
                              ...
                              : '14px',
                        fontFamily: `${textBlocks[1]?.styles?.fontFamily ?? 'Montserrat Alternates'}, sans-serif`,
                            ...
                            style={{
                                ...
                                fontSize: isMobileDevice
                                    ...
                                    : textBlocks[2]?.styles?.fontSize
                                      ...
                                      : '14px',
                                fontFamily: `${textBlocks[2]?.styles?.fontFamily ?? 'Montserrat Alternates'}, sans-serif`,
