...
import ScrollWidget from '../../LandingPage/ScrollWidget';
    ...
    return (
        <section className={styles.section_reviews}>
            <div className={styles.section_reviews_title_container}>
                ...
                <div className={styles.section_reviews_p}>
                    Команды разработчиков любят
                    <span style={{ color: '#1E4DC2' }}>Открытые идеи</span>
                </div>
            </div>
